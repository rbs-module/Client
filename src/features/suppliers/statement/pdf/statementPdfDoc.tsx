...
import { SupplierStatementType } from "@/types/customer";
...
function SupplierStatementPDFDoc({
  pageData,
  organization,
}: {
  pageData: SupplierStatementType;
        ...
        <Page size="A4" style={styles.page} wrap={true}>
          ...
          <View style={{ padding: "40px", paddingTop: "5px" }}>
            <Text style={styles.subTitle}>
              Sub Ledger For : {pageData.data.supplier.name}
            </Text>
...
export default SupplierStatementPDFDoc;
