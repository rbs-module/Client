...
import { useGetPaymentChartQuery } from "@/services/payments";
...
export function usePaymentChart(query?: Partial<ChatDataQuery>) {
  ...
  const { data, isFetching } = useGetPaymentChartQuery(queryState);
