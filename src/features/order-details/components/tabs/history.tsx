...
import { useGetOrderHistoryQuery } from "@/services/orders";
import {
  Box,
  Card,
  Container,
...
const getIcon = (action: OrderHistoryType["action"]) => {
  if (action == "updated") {
...
const getIconStyle = (action: OrderHistoryType["action"]) => {
  if (action == "created") {
    return {
...
function OrderHistory() {
  ...
  const { data, isFetching, refetch } = useGetOrderHistoryQuery({
    id,
